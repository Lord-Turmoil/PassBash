...
**+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
*/
static const char DFL_TITLE[] = "Demo Project";
static const char DFL_COPYRIGHT[] = "Tony's Studio 2020 - 2023";
static const char DFL_AUTHOR[] = "Tony Skywalker";
...
**+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
*/
static const WORD DFL_FOREGROUND = FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE;
static const WORD DFL_BACKGROUND = 0;
